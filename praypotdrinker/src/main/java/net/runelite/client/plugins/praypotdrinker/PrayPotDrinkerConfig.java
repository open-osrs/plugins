...
public interface PrayPotDrinkerConfig extends Config
{
    ...
    default String potionNames() { return new String("Prayer potion(1),Prayer potion(2),Prayer potion(3),Prayer potion(4),Super restore(4),Super restore(3),Super restore(2),Super restore(1)"); }
}
