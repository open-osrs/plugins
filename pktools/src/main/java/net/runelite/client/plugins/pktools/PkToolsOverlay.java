...
public class PkToolsOverlay extends Overlay
{
	...
	static final int[] MELEE_LIST = {ItemID.DRAGON_SCIMITAR, ItemID.RUNE_SCIMITAR, ItemID.GRANITE_MAUL,
			...
			ItemID.SARADOMIN_GODSWORD_OR, ItemID.ARMADYL_GODSWORD_OR, ItemID.ARMADYL_GODSWORD_20593,
			ItemID.ARMADYL_GODSWORD_22665, ItemID.BANDOS_GODSWORD_20782, ItemID.BANDOS_GODSWORD_21060,
			ItemID.BANDOS_GODSWORD_OR, ItemID.SARACHNIS_CUDGEL, ItemID.SCYTHE_OF_VITUR, ItemID.SCYTHE_OF_VITUR_22664,
			ItemID.SCYTHE_OF_VITUR_UNCHARGED, ItemID.ZAMORAKIAN_SPEAR, ItemID.ZAMORAKIAN_HASTA
	};
	...
	static final int[] RANGED_LIST = {ItemID.RUNE_CROSSBOW, ItemID.MAGIC_SHORTBOW_I, ItemID.ARMADYL_CROSSBOW,
			...
			ItemID.DRAGON_KNIFEP_22810, ItemID.RUNE_THROWNAXE
	};
	...
	static final int[] MAGIC_LIST = {ItemID.TOXIC_STAFF_OF_THE_DEAD, ItemID.MYSTIC_SMOKE_STAFF,
			...
			ItemID.STAFF_OF_THE_DEAD_23613, ItemID.TRIDENT_OF_THE_SEAS_FULL, ItemID.TRIDENT_OF_THE_SEAS,
			...
			ItemID.AHRIMS_STAFF_0, ItemID.MUD_BATTLESTAFF, ItemID.MYSTIC_MUD_STAFF, ItemID.WHITE_MAGIC_STAFF,
			...
			ItemID.SANGUINESTI_STAFF_UNCHARGED, ItemID.STAFF_OF_BALANCE
	};
}