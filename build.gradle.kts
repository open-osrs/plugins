...
subprojects {
    ...
    dependencies {
        ...
        implementation(group = "com.openosrs", name = "http-api", version = "3.3.+")
        implementation(group = "com.openosrs", name = "injected-client", version = "3.3.+")
        implementation(group = "com.openosrs", name = "runelite-api", version = "3.3.+")
        implementation(group = "com.openosrs", name = "runelite-client", version = "3.3.+")
        implementation(group = "com.openosrs.rs", name = "runescape-api", version = "3.3.+")
        implementation(group = "com.openosrs.rs", name = "runescape-client", version = "3.3.+")
